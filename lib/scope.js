...
function Scope(){
    ...
    this.addFromDir = function(dirPath, constructorArgs){
...
//                            let sf = funcinfos(fnc);
                            ...
                            // Assume a function is a constructor
                            if(mod.__init && typeof mod.__init == "function"){
                                inits.push(mod.__init);
                            }
    ...
    let inits=[];
    this.initialise = function(extend){
        let e = extend || {};
        return new Promise(
            (res, rej)=>{
                nextr(inits,
