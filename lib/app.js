...
function APP(options){
    ...
    this.start = ()=>{
        ...
        this.emit('express.loading', expressApp, api );
            ...
            (stores)=>{
                ...
                mloader.each(
                    (m)=>{
                        ...
                        scope.addFromDir( path.join(m.path, 'controllers'), [stores] );
                    }
                );
                scope.initialise().then(
                    ()=>{
                        mloader.sync(
                            (next, m)=>{
                                let n=()=>{
                                ...
                                if(typeof m.start == "function"){
                                    scope.exec( m.start, {next: n, api:api, app:this, expressd:this, options:opts} );
                                } else {
                                    n();
                                }
                            },
